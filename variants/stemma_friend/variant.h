...
#ifndef _VARIANT_STEMMAFRIEND_ZERO_
#define _VARIANT_STEMMAFRIEND_ZERO_
...
static const uint8_t SS	  = 5 ;	// TFT CS
...
//#define WIRE1_IT_HANDLER      SERCOM2_Handler    // hack! we call the i2c handler from within the serial handler!
